########################################
# Environment: Java Training
# AWS Account: 160198385987  (profile: itcjavatraining)
# Workspace:   java   -> resources named tf-java-<svc>-<key>-<suffix>
#
# Usage:
#   cd aws
#   terraform workspace new java       # first time only
#   terraform workspace select java
#   terraform plan  -var-file=envs/java.tfvars
#   terraform apply -var-file=envs/java.tfvars
#
...
########################################
s3_buckets = {
  s3_1 = { bucket_prefix = "itc-java-training" }
}
...
########################################
lambda_functions = {
  # fn_1 = { role_arn = "arn:aws:iam::160198385987:role/lambda-role", runtime = "python3.11", handler = "lambda_function.lambda_handler" }
}
