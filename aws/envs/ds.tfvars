########################################
# Environment: DS Training
# AWS Account: 666127452756  (profile: dstraining)
# Workspace:   ds   -> resources named tf-ds-<svc>-<key>-<suffix>
#
# Usage:
#   cd aws
#   terraform workspace new ds         # first time only
#   terraform workspace select ds
#   terraform plan  -var-file=envs/ds.tfvars
#   terraform apply -var-file=envs/ds.tfvars
#
...
########################################
s3_buckets = {
  s3_1 = { bucket_prefix = "itc-ds-training" }
}
...
########################################
lambda_functions = {
  # fn_1 = { role_arn = "arn:aws:iam::666127452756:role/lambda-role", runtime = "python3.11", handler = "lambda_function.lambda_handler" }
}
